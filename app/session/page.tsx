...
.from(“sessions”)
.select(
`id, title, objective, patient_id, session_blocks ( id, sequence_order, rest_before_ms, title_override, session_block_exercises ( sequence_order, reps_override, hold_ms_override, exercise_templates ( name, display_name, default_reps, default_hold_ms, coaching_strings ) ) ), prescription_exercises ( sequence_order, reps_override, hold_ms_override, exercise_templates ( name, display_name, default_reps, default_hold_ms, coaching_strings ) )`
)
